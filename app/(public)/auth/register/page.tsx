  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-background via-teal-950/5 to-background flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Sign Up Form Card */}
        <div className="bg-black/50 backdrop-blur-md border border-teal-500/20 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-teal-400/50" />
                <input
                  {...register("fullName", {
                  ...
                  className="w-full bg-background/50 border border-teal-500/20 rounded-lg pl-10 pr-4 py-3 text-foreground placeholder-muted-foreground focus:outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/50 transition-all"
                />
              </div>
              {errors.fullName && (
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-teal-400/50" />
                <input
                  {...register("email", {
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-teal-400/50" />
                <input
                  {...register("password", {
                  ...
                  placeholder="••••••••"
                  className="w-full bg-background/50 border border-teal-500/20 rounded-lg pl-10 pr-10 py-3 text-foreground placeholder-muted-foreground focus:outline-none focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/50 transition-all"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-teal-400/50 hover:text-teal-400 transition-colors"
                >
                  {showPassword ? (
          ...
          <Button
            variant="outline"
            className="w-full border-teal-500/20 hover:border-teal-500/50 bg-background/20 text-foreground"
          >
